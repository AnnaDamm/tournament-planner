...
- Fix time handling between rounds.

## v2.1.1

### Bugfixes

- Improve start-time handling and round-related UX.

## v2.1.0

### Features

- Enhance tournament views and round management.

## v2.0.4

### Bugfixes

- Update dependency automation and formatting configuration.

## v2.0.3

### Bugfixes

- Increase the maximum winning-games setting to 99.

## v2.0.2

### Features

- Improve match scoring, read-only links, service-worker caching, and layouts.

## v2.0.1

### Bugfixes

- Improve interactive control semantics.
...
- Improve rerolling existing match scores.

## v1.2.1

### Features

- Enable matches across active rounds.

## v1.2.0

### Bugfixes

- Fix 404 handling, bye logic, and release workflow warnings.
